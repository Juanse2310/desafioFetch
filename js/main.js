...
//     {
//         id: 1,
//         nombre:"Maquina de tatuajes",
//         precio: 3500,
//         imagen: src="./Imagenes/img1.jpeg",
//     },
//     {
//         id: 2,
//         nombre:"Pack Punteras",
//         precio: 850,
//         imagen: "./Imagenes/img2.jpg",
//     },
//     {
//         id: 3,
//         nombre:"Maquina Digital",
//         precio: 5750,
...
//secciones
fetch("https://fakestoreapi.com/products").then((datos)=>{
    return datos.json();
}).then((datosExtraidos)=>{
    console.log(datosExtraidos[0].title);
    let datosTabla="";
    datosExtraidos.map((valor)=>{
        datosTabla+=` <tr>
        <td>${valor.title}</td>
        <td>${valor.description}</td>
        <td>${valor.price}</td>
        <td><img src="${valor.image}"</td>
        </tr>`;
    });
    document.getElementById("table_body").innerHTML=datosTabla;
})